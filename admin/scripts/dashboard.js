function booking_analytics(period=1)
{
    ...
    document.getElementById('table-bookings').textContent=data.total_bookings;
    document.getElementById('table-amt').textContent=data.total_amt;


    document.getElementById('cancelled_bookings').textContent=data.cancelled_bookings;
    document.getElementById('cancelled_amt').textContent=data.active_amt;
