<?php
    ...
    if(isset($_POST['add_room'])){
        ...
        if($stmt = mysqli_prepare($con,$q2)){
            ...
            $flag=0;
            die('query cannot be prpared-insert');
        }
            ...
            if($row['thumb']==1)
            {
              ...
              echo<<<data
                <tr class='align-middle'>
                    ...
                    <td>$thumb_btn</td>
                    <td>
                        <button onclick='rem_image($row[sr_no],$row[room_id])' class='btn btn-warning btn-sm shadow-none'>
                            <i class='bi bi-trash'></i>
                        </button>
                    </td>
                </tr>
    ...
    if(isset($_POST['remove_room']))
    {
        ...
        $res2= del("DELETE FROM `rooms_images` WHERE  `room_id`=?",[$frm_data['room_id']],'i');
